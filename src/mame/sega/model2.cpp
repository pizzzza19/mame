...
static INPUT_PORTS_START( daytona )
	...
	PORT_START("ACCEL")
	PORT_BIT(0xff, 0x00, IPT_PEDAL)  PORT_MINMAX(0x20, 0xe0) PORT_SENSITIVITY(50) PORT_KEYDELTA(20)

	PORT_START("BRAKE")
	PORT_BIT(0xff, 0x00, IPT_PEDAL2) PORT_MINMAX(0x20, 0xe0) PORT_SENSITIVITY(50) PORT_KEYDELTA(20)
