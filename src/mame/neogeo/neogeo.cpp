...
ROM_START( kof96a ) /* MVS alternative version repaired by SNK (bug fix) */ 
	ROM_REGION( 0x300000, "maincpu", 0 ) /* EP1~EP4 are provided as EPROM without label */
	...
	NEO_BIOS_AUDIO_128K( "214.m1", CRC(dabc427c) SHA1(b76722ed142ee7addceb4757424870dbd003e8b3) ) /* It is provided as EPROM without label */
